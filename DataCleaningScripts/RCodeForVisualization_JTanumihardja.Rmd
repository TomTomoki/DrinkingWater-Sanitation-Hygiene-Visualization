...
```{r}
water1 <- read_csv("C:/Users/jtanu/Documents/Northeastern/2023SPRING/IE6600/Assignment/FinalProject/water1.csv")

water2 <- read_csv("C:/Users/jtanu/Documents/Northeastern/2023SPRING/IE6600/Assignment/FinalProject/water2.csv")
```
...
sanitation1 %>% 
  ...
  group_by(YEAR, ServiceLevel) %>% #combine all country
  summarise(popul = sum(Percentage/100 * `POPULATION(THOUSANDS)`, #sum of all countries
...
```{r}
sanitation1 <- read_csv("C:/Users/jtanu/Documents/Northeastern/2023SPRING/IE6600/Assignment/FinalProject/sanitation1.csv")

sanitation2 <- read_csv("C:/Users/jtanu/Documents/Northeastern/2023SPRING/IE6600/Assignment/FinalProject/sanitation2.csv")
```
...
```{r}
hygiene1 <- read_csv("C:/Users/jtanu/Documents/Northeastern/2023SPRING/IE6600/Assignment/FinalProject/hygiene1.csv")
```
